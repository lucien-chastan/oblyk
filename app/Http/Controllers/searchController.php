...
class searchController extends Controller
{
    ...
    public function search($limit, $offset, $type, $search){
        ...
        if($type == 'words' || $type == 'all') {
            foreach (Searchy::search('words')->fields('label')->query($search)->getQuery()->limit(20)->get() as $find) {
        ...
        if($type == 'crags' || $type == 'all') {
            foreach (Searchy::search('crags')->fields('label', 'city', 'region')->query($search)->getQuery()->limit(20)->get() as $find) {
        ...
        if($type == 'users' || $type == 'all') {
            foreach (Searchy::search('users')->fields('name')->query($search)->getQuery()->limit(20)->get() as $find) {
        ...
        if($type == 'gyms' || $type == 'all') {
            foreach (Searchy::search('gyms')->fields('label', 'city', 'big_city')->query($search)->getQuery()->limit(20)->get() as $find) {
        ...
        if($type == 'routes' || $type == 'all') {
            foreach (Searchy::search('routes')->fields('label')->query($search)->select('id')->getQuery()->limit(20)->get() as $find) {
        ...
        if($type == 'helps' || $type == 'all') {
            foreach (Searchy::search('helps')->fields('label', 'category')->query($search)->getQuery()->limit(20)->get() as $find) {
        ...
        if($type == 'topics' || $type == 'all') {
            foreach (Searchy::search('forum_topics')->fields('label')->query($search)->select('id')->getQuery()->limit(20)->get() as $find) {
        ...
        if($type == 'topos' || $type == 'all') {
            foreach (Searchy::search('topos')->fields('label', 'author', 'editor')->query($search)->getQuery()->limit(20)->get() as $find) {
