...
return [
    ...
    'descriptionWelcomeBox' => "Affiche une boîte qui te souhaite la bienvenue et t'explique le fonctionnement du dashboard",

    'labelFriendsCrossesBox' => "Croix des potes",
    'descriptionFriendsCrossesBox' => "Affiche une boîte qui te montre les dernières réalisations de tes potes",
    ...
    'labelLastCommentBox' => "Les derniers commentaires",
    'descriptionLastCommentBox' => "Affiche les derniers commentaires postées sur des voies sur Oblyk",

    'labelLastCragBox' => "Les dernières falaises ajoutées",
    'descriptionLastCragBox' => "Affiche les dernières falaises qui ont été ajoutées sur Oblyk",

    'labelLastTopicBox' => "Les derniers sujets du forum",
    ...
    'descriptionPublic' => "Ma page à propos, mes photos, vidéo et carnet de croix sont visibles par la communauté. (mais reste invisible pour les non-inscrits)",
