...
return [
    ...
    'descriptionAccount' => '
        En rejoignant Oblyk tu auras librement accès à toutes les infos de la communauté, tu pourras te tenir au courant de ce qui se passe dans le
        monde de la grimpe, tu pourras tenir un carnet de croix pour t\'aider à progresser ou pour garder un souvenir de tes passages en falaise.<br>
        Et tu pourras participer à l\'élaboration d\'une grande base de connaissance commune des sites d\'escalade de France et du monde !
    ',
    ...
    'descriptionGuidebook' => "
        ...
        Sachez que nous nous sommes beaucoup posé cette question aussi. Et la réponse est non, Oblyk ne peut pas remplacer un topo !<br>
        Les topos contiennent des informations indispensables que nous ne permettons pas d'ajouter sur oblyk<br><br>
    ...
    'route_today'=>'Une nouvelle ligne a été ajoutée aujourd\'hui|:count lignes ont été ajoutées aujourd\'hui ',
    'cross_today'=>'Une nouvelle croix a été faite aujourd\'hui|:count croix ont été faites aujourd\'hui ',
    'photo_today'=>'Une nouvelle photo a été ajoutée aujourd\'hui|:count photos ont été ajoutées aujourd\'hui ',
