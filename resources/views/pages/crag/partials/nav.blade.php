<div class="row">
    <div class="col s12">
        <ul class="tabs tabs-fixed-width crag-menu">
            ...
            <li class="tab col s2"><a data-route="{{route('vueToposCrag',[$crag->id])}}" class="router-link" href="#topos"><i class="material-icons">local_library</i><span>Topos</span></a><span class="count-tab-ettiquette">{{$crag->topos_count}}</span></li>
