<div class="row">
    <div class="col s12">
        <ul class="tabs tabs-fixed-width crag-menu">
            ...
            <li class="tab col s2"><a data-route="{{route('vueSecteurCrag',[$crag->id])}}" class="router-link" href="#voies"><i class="material-icons">format_list_bulleted</i><span>Secteurs &amp; Voies</span></a></li>
