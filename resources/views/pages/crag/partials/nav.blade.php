<div class="row">
    <div class="col s12">
        <ul class="tabs tabs-fixed-width crag-menu">
            ...
            <li class="tab col s2"><a data-route="{{route('vueFilActuCrag',[$crag->id])}}" data-callback="getCragPosts" class="router-link" href="#fil-actu"><i class="material-icons">shuffle</i><span>Fil d'actu</span></a><span class="count-tab-ettiquette">{{$crag->posts_count}}</span></li>
            ...
            <li class="tab col s2"><a data-route="{{route('vueToposCrag',[$crag->id])}}" class="router-link" href="#topos"><i class="material-icons">local_library</i><span>Topos</span></a><span class="count-tab-ettiquette">{{$crag->topos_count + $crag->topo_pdfs_count + $crag->topo_webs_count}}</span></li>
