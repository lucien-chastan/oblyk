<div class="row">
    <div class="col s12">
        <ul class="tabs tabs-fixed-width crag-menu">
            ...
            <li class="tab col s2"><a data-route="{{ route('vueMediasCrag',[$crag->id]) }}" class="router-link" href="#medias"><i class="material-icons">collections</i><span>@lang('pages/crags/global.tabMedia')</span></a><span class="count-tab-ettiquette">{{ count($cragPhotos) + $crag->videos_count }}</span></li>
