<div class="card-panel">
    ...
    @if(Auth::check() && $ImThere == false)
        @if($user->partnerSettings->partner == 0)
            <p class="text-center">
                <a href="{{ $user->url() }}#partenaire-parametres" class="btn-flat blue-text"><i class="material-icons left">person_pin</i> @lang('pages/crags/tabs/informations.activePartner')</a>
            </p>
        @else
            <p class="text-center">
