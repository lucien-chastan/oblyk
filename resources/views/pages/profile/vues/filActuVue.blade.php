...
@if(Auth::check())
    <div class="fixed-action-btn horizontal">
        <a {!! $Helpers::tooltip(trans('modals/post.addTooltip')) !!} {!! $Helpers::modal(route('postModal'), ["postable_id"=>$user->id, "postable_type"=>"User", "post_id"=>"", "title"=>trans('modals/post.modalAddTitle'), "method"=>"POST" ]) !!} class="btn-floating btn-large red waves-effect waves-light tooltipped btnModal">
