<div class="row">
    <div class="col s12">
        <ul class="tabs tabs-fixed-width topo-menu">
            ...
            <li class="tab col s2"><a data-route="{{ route('vuePhotosTopo',$topo->id) }}" class="router-link" href="#photos"><i class="material-icons">photo</i><span>@lang('pages/guidebooks/global.photosTab')</span></a><span class="count-tab-ettiquette">{{ $photos_count }}</span></li>
            ...
            <li class="tab col s2"><a data-route="{{ route('vueMapTopo',$topo->id) }}" data-callback="initTopoMap" class="router-link" href="#map"><i class="material-icons">map</i><span>@lang('pages/guidebooks/global.mapTab')</span></a><span class="count-tab-ettiquette">{{ $topo->crags_count + $topo->sales_count }}</span></li>
        </ul>
    </div>
</div>