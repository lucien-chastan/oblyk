...
<div class="row">
    ...
    <div id="btn-see-more-post" class="text-center text-bold btn-see-more-post">
        <div id="btn-a-see-more-post">
            <a class="btn-flat grey-text" onclick="showLoadedMorePost(true);getTopoPosts()">
...
@if(Auth::check())
    <div class="fixed-action-btn horizontal">
        <a {!! $Helpers::tooltip(trans('modals/post.addTooltip')) !!} {!! $Helpers::modal(route('postModal'), ["postable_id"=>$topo->id, "postable_type"=>"Topo", "post_id"=>"", "title"=>trans('modals/post.modalAddTitle'), "method"=>"POST" ]) !!} class="btn-floating btn-large red waves-effect waves-light tooltipped btnModal">
