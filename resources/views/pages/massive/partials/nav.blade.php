<div class="row">
    <div class="col s12">
        <ul class="tabs tabs-fixed-width massive-menu">
            ...
            <li class="tab col s2"><a data-route="{{route('vueFilActuMassive',$massive->id)}}" class="router-link" href="#fil-actu"><i class="material-icons">shuffle</i><span>Fil d'actu</span></a><span class="count-tab-ettiquette">0</span></li>
