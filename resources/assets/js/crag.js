...
function uploadCragCsv(form, callback) {
    ...
    data.append('foo', 'bar');
    data.append('file', document.getElementById('upload-input-csv').files[0]);
    ...
    let config = {
        onUploadProgress: function(progressEvent) {
            ...
            document.getElementById('progressbar-upload-csv').style.width = percentCompleted + '%';
        }
    };
